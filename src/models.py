...
class Favorites(Base):
    ...
    users_id = Column(Integer, ForeignKey('Characters.id'), nullable=True)

    users_id = Column(Integer, ForeignKey('Planets.id'), nullable=True)
